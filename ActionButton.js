    ...
    return (
      <View
        style={[
          ...
          {
            marginBottom: this.props.centerButtonBottomMargin,
            marginLeft: this.props.centerButtonLeftMargin,
          },
        ]}
      >
        <TouchableOpacity
      ...
      return (
        <View
          ...
          style={[
            ...
            /* { marginBottom: Platform.OS === 'ios' ? 35 : 20, marginLeft: 10 } */
          ]}
        >
          <ActionButtonItem
            key={index}
            ...
            actionItemBottom={this.props.actionItemBottom}
          />
        </View>
      )
    })
